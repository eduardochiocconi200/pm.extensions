...
public class WorkflowSimulationSamplesTest5
    extends WorkflowSimulationSamples
{
    public WorkflowSimulationSamplesTest5(final String numberOfInstances)
    {
    ...
    public HashMap<String, ProcessMiningModelTransition> getTransitions()
    {
        ...
        transition3.setMaxDuration(500);
        transition3.setAvgDuration(300);
        transition3.setMedianDuration(290);
        transition3.setTotalDuration(5000);
