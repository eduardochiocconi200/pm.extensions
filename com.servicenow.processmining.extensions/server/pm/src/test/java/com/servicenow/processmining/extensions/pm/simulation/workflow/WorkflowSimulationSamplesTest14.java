...
public class WorkflowSimulationSamplesTest14
    extends WorkflowSimulationSamples
{
    private ProcessMiningModel model = null;

    public WorkflowSimulationSamplesTest14(final String numberOfInstances)
    {
    ...
    {
        if (model == null) {
            String processMiningModelJSONString = new TestUtility().loadProcessMiningModel("/model/payload13-z.json");
