...
import com.servicenow.processmining.extensions.pm.simulation.workflow.WorkflowSimulationSamples;

import java.util.ArrayList;
import java.util.HashMap;

public class WorkflowSimulationComparisonSamplesTest1
    extends WorkflowSimulationSamples
{
    public WorkflowSimulationComparisonSamplesTest1(final String numberOfInstances)
    {
    ...
    public HashMap<String, ProcessMiningModelTransition> getTransitions()
    {
        ...
        transition2.setMinDuration(7200);
        transition2.setMaxDuration(7200);
        transition2.setAvgDuration(7200);
        transition2.setMedianDuration(7200);
