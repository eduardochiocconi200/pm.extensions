...
public class ProcessMiningModelRetrievalUtah
    extends ProcessMiningModelRetrieval
{
    public ProcessMiningModelRetrievalUtah(final ServiceNowInstance instance, final String modelVersionId)
    {
