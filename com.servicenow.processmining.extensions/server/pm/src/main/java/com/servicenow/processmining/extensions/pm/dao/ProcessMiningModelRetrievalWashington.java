...
public class ProcessMiningModelRetrievalWashington
    extends ProcessMiningModelRetrieval
{
    public ProcessMiningModelRetrievalWashington(final ServiceNowInstance instance, final String modelVersionId)
    {
