...
public class ProcessMiningVariantRetrievalWashington
    extends ProcessMiningModelRetrieval
{
    private String entityId = null;
    private int numberOfVariants = 0;

    public ProcessMiningVariantRetrievalWashington(final ServiceNowInstance instance, final String modelVersionId, final String entityId, final int numberOfVariants)
    {
    ...
    {
        logger.debug("Enter ProcessMiningVariantRetrievalWashington.getEmptyFilterPayload()");
        String variables = "{\n" + 
        ...
        logger.debug("Exit ProcessMiningVariantRetrievalWashington.getEmptyFilterPayload()");
        return payload;
    }

    protected String getFilterPayload(final String entityId, final ProcessMiningModelFilter filter)
    {
        logger.debug("Enter ProcessMiningVariantRetrievalWashington.getBreakdownsFilterPayload()");
        String variables = "{\n" + 
                "\t\"versionId\": \"" + getProcessModelVersionId() + "\",\n" + 
                "\t\"entityId\": \"" + getEntityId() + "\",\n" + 
                "\t\"filterSets\": {\n" + 
